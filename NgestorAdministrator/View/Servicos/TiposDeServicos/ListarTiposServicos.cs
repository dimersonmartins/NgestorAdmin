...
namespace NgestorAdministrator.View.Servicos.TiposDeServicos
{
    public partial class ListarTiposServicos : UserControl
    {
        public ListarTiposServicos()
        {
            InitializeComponent();
        }
        ...
        {
            TopHeader topHeader = new TopHeader("Serviço","Tipos de Baixa");
